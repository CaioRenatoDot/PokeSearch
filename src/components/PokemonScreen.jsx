...
export default function PokemonScreen({ pokemon, status, message }) {
  return (
    <motion.section
      className="relative min-h-0 overflow-hidden rounded-lg border-[10px] border-dex-dark bg-dex-screen shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2),inset_0_0_52px_rgba(18,48,46,0.2)] lg:h-full lg:rounded-l-none"
    ...
    >
      ...
      <div className="relative z-0 flex h-full min-h-[calc(100vh-210px)] p-4 sm:p-6 lg:min-h-0 lg:p-8">
